tr = {
  'en': {
    ...
    "about_payouts": "If you create an account and ask questions with this account, each month 50% of the ad revenue generated by Google AdSense for your questions will be credited to your account in Bitcoin."
  }
}
